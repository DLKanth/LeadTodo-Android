package firebaseappfest.com.leadtodoandroid.utils;
...
/**
 * This util class is used to get on click support on recycler view
 */
        ...
        public boolean onLongClick(View v) {
            if (onItemLongClickListener != null) {
                ...
                return onItemLongClickListener
                        .onItemLongClicked(recyclerView, holder.getAdapterPosition(), v);
            }
            return false;
        }
    };
